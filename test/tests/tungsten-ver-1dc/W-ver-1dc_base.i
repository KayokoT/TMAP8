...
epsilon_1 = ${units 13925.421746094702 K}
epsilon_2 = ${units 9863.840403483748 K}
epsilon_3 = ${units 13925.421746094702 K}
temperature = ${units 1500 K}
trapping_site_fraction_1 = 0.005 # (-)
trapping_site_fraction_2 = 0.01 # (-)
trapping_site_fraction_3 = 0.005 # (-)
