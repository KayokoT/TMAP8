...
# 1 trap in W corresponding to "trap 2" in the .params file
...
[AuxKernels]
  ...
  [W_total_sites]
    ...
    type = ParsedAux
    expression = 'W_trapped_sites_2 + W_empty_sites_2'
    coupled_variables = 'W_trapped_sites_2 W_empty_sites_2'
    block = '0'
  []
[]
...
[Postprocessors]
  ...
  [W_mass_from_concentration]
    type = ParsedPostprocessor
    expression = 'trapped_W_mass_2_physical'
    pp_names = 'mobile_W_mass trapped_W_mass_2_physical'
    outputs = main
  []
